...
// const addPaginator = (options) => {
//     const paginatorContainer = document.querySelector('#paginator');
//     paginatorContainer.innerHTML = pages.length > 1 ? `<ul class="page"><li onclick="previousPage()" class="page__btn"><span class="material-icons">chevron_left</span></li>` : '';
//     for (let i = 0; i < pages.length; i++) {
//         const paginatorButton = `<li onclick="showPage(${i})" class="page__numbers"> ${i + 1}</li>`;
//         paginatorContainer.innerHTML += paginatorButton;
//     }
