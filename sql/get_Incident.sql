...
where t1.sprint_id=incident_ticket.sprint_id and t2.emp_id=incident_ticket.created_by and t3.sprint_id=incident_ticket.sprint_id and incident_ticket.ticket_id=%s;
