...
INSERT INTO `change_ticket` VALUES ('CHG134','ABC','2022-11-05','Open','P1',1,1,1,1),('CHG22345','AWS change','2020-05-10','Open','P1',1,2,1,1),('CHG22346','Azure change','2020-04-09','In Progress','P2',2,1,2,2),('CHG22347','Oracle change table','2019-01-10','Closed','P3',5,4,3,3);
...
INSERT INTO `incident_ticket` VALUES ('INC123','Test Error','2022-11-24','Open','P1',1,1),('INC12346','Azure Login Error','2020-04-09','In Progress','P2',2,1),('INC12347','Oracle Tables Error','2019-01-09','Closed','P3',5,3),('INC12348','Database Error','2022-01-09','Open','P1',7,5),('INC12349','DS values Error','2021-01-09','Closed','P2',6,4);
...
INSERT INTO `manager` VALUES (4,3),(123,4),(124,6);
...
INSERT INTO `request_ticket` VALUES ('REQ12345678','Create new functionality','2022-11-30','In Progress','P2',1004,126),('REQ12348','Database Create','2022-01-09','Open','P1',7,5),('REQ12349','DS new usecase','2021-01-09','Closed','P2',6,4),('REQ22345','AWS Access','2020-05-09','Open','P1',1,1),('REQ22346','Azure Access','2020-04-09','In Progress','P2',2,2),('REQ22347','Oracle Tables Create','2019-01-09','Closed','P3',5,3);
...
INSERT INTO `sprint_team` VALUES (1,1),(3,1),(90,1),(123,1),(999,1),(2,2),(4,2),(5,3),(6,4),(7,5),(1004,6),(1005,6);
...
-- Dump completed on 2022-11-23 23:40:27
